...
def main():
#    genFeatureDefination('plays')
#    genFeatureDefination('avg_plays_last_3_days')
#    genFeatureDefination('avg_plays_last_5_days')
#    genFeatureDefination('avg_plays_last_7_days')
#    genFeatureDefination('downloads')
#    genFeatureDefination('avg_downloads_last_3_days')
#    genFeatureDefination('avg_downloads_last_5_days')
#    genFeatureDefination('avg_downloads_last_7_days')
#    genFeatureDefination('collects')
#    genFeatureDefination('avg_collects_last_3_days')
#    genFeatureDefination('avg_collects_last_5_days')
#    genFeatureDefination('avg_collects_last_7_days')
#    genFeatureDefination('diff_plays')
#    genFeatureDefination('diff_downloads')
#    genFeatureDefination('diff_collects')
#    genFeatureDefination('plays_div_plays_prev_1_days')
#    genFeatureDefination('plays_div_plays_prev_2_days')
#    genFeatureDefination('plays_div_plays_prev_4_days')
#    genFeatureDefination('plays_div_plays_prev_6_days')
#    genFeatureDefination('plays_div_downloads')
#    genFeatureDefination('plays_div_downloads_last_3_days')
#    genFeatureDefination('plays_div_downloads_last_5_days')
#    genFeatureDefination('plays_div_downloads_last_7_days')
#    genFeatureDefination('plays_div_collects')
    genFeatureDefination('plays_div_collects_last_3_days')
    genFeatureDefination('plays_div_collects_last_5_days')
    genFeatureDefination('plays_div_collects_last_7_days')
#    genFeatureDefination('play_users')
#    genFeatureDefination('avg_play_users_last_3_days')
#    genFeatureDefination('avg_play_users_last_5_days')
#    genFeatureDefination('avg_play_users_last_7_days')
